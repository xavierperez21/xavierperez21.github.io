        ...
        return (
            <nav id="nav">
                ...
                <ul className="navbar__items">
                    ...
                    <li className="navbar__items-item resume"><a href="../LuisXavierPerezResume.pdf" type="application/pdf" rel="noopener noreferrer" target="_blank"><span className="resume-text">Resume</span></a></li>
                </ul>
            </nav>
        );
    }
